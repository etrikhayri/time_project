...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.classe' => 'getSonata_Admin_ClasseService',
            'sonata.admin.controller.admin' => 'getSonata_Admin_Controller_AdminService',
            'sonata.admin.eleve' => 'getSonata_Admin_EleveService',
            ...
            'sonata.admin.matiere' => 'getSonata_Admin_MatiereService',
            ...
            'sonata.admin.planning' => 'getSonata_Admin_PlanningService',
            'sonata.admin.pool' => 'getSonata_Admin_PoolService',
            'sonata.admin.professeur' => 'getSonata_Admin_ProfesseurService',
            ...
            'sonata.admin.salle' => 'getSonata_Admin_SalleService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'Time', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Admin\\AdminBundle\\Resources\\config\\doctrine') => 'Admin\\AdminBundle\\Entity'));
        $b->setGlobalBasename('mapping');

        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Admin\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Blogger\\BlogBundle\\Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Admin\\AdminBundle\\Entity');
        $d->addDriver($c, 'Admin\\UserBundle\\Entity');
        $d->addDriver($c, 'Blogger\\BlogBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('AdminAdminBundle' => 'Admin\\AdminBundle\\Entity', 'AdminUserBundle' => 'Admin\\UserBundle\\Entity', 'BloggerBlogBundle' => 'Blogger\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_31d7c9973f4c34fe395ac17476ab6a8be570a9ac30225ffbbca95795ffab3eea');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '@secret@', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    /**
     * Gets the 'sonata.admin.classe' service.
     *
     * @return \Admin\AdminBundle\Admin\ClasseAdmin A Admin\AdminBundle\Admin\ClasseAdmin instance.
     */
    protected function getSonata_Admin_ClasseService()
    {
        $instance = new \Admin\AdminBundle\Admin\ClasseAdmin('sonata.admin.classe', 'Admin\\AdminBundle\\Entity\\Classe', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.eleve' service.
     *
     * @return \Admin\AdminBundle\Admin\EleveAdmin A Admin\AdminBundle\Admin\EleveAdmin instance.
     */
    protected function getSonata_Admin_EleveService()
    {
        $instance = new \Admin\AdminBundle\Admin\EleveAdmin('sonata.admin.eleve', 'Admin\\AdminBundle\\Entity\\Eleve', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.matiere' service.
     *
     * @return \Admin\AdminBundle\Admin\MatiereAdmin A Admin\AdminBundle\Admin\MatiereAdmin instance.
     */
    protected function getSonata_Admin_MatiereService()
    {
        $instance = new \Admin\AdminBundle\Admin\MatiereAdmin('sonata.admin.matiere', 'Admin\\AdminBundle\\Entity\\Matiere', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata.admin.planning' service.
     *
     * @return \Admin\AdminBundle\Admin\PlanningAdmin A Admin\AdminBundle\Admin\PlanningAdmin instance.
     */
    protected function getSonata_Admin_PlanningService()
    {
        $instance = new \Admin\AdminBundle\Admin\PlanningAdmin('sonata.admin.planning', 'Admin\\AdminBundle\\Entity\\Planning', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.eleve', 1 => 'sonata.admin.classe', 2 => 'sonata.admin.matiere', 3 => 'sonata.admin.professeur', 4 => 'sonata.admin.salle', 5 => 'sonata.admin.planning'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.eleve', 1 => 'sonata.admin.classe', 2 => 'sonata.admin.matiere', 3 => 'sonata.admin.professeur', 4 => 'sonata.admin.salle', 5 => 'sonata.admin.planning'))));
        $instance->setAdminClasses(array('Admin\\AdminBundle\\Entity\\Eleve' => array(0 => 'sonata.admin.eleve'), 'Admin\\AdminBundle\\Entity\\Classe' => array(0 => 'sonata.admin.classe'), 'Admin\\AdminBundle\\Entity\\Matiere' => array(0 => 'sonata.admin.matiere'), 'Admin\\AdminBundle\\Entity\\Professeur' => array(0 => 'sonata.admin.professeur'), 'Admin\\AdminBundle\\Entity\\Salle' => array(0 => 'sonata.admin.salle'), 'Admin\\AdminBundle\\Entity\\Planning' => array(0 => 'sonata.admin.planning')));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.professeur' service.
     *
     * @return \Admin\AdminBundle\Admin\ProfesseurAdmin A Admin\AdminBundle\Admin\ProfesseurAdmin instance.
     */
    protected function getSonata_Admin_ProfesseurService()
    {
        $instance = new \Admin\AdminBundle\Admin\ProfesseurAdmin('sonata.admin.professeur', 'Admin\\AdminBundle\\Entity\\Professeur', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.eleve', 1 => 'sonata.admin.classe', 2 => 'sonata.admin.matiere', 3 => 'sonata.admin.professeur', 4 => 'sonata.admin.salle', 5 => 'sonata.admin.planning'), $this);
    }

    /**
     * Gets the 'sonata.admin.salle' service.
     *
     * @return \Admin\AdminBundle\Admin\SalleAdmin A Admin\AdminBundle\Admin\SalleAdmin instance.
     */
    protected function getSonata_Admin_SalleService()
    {
        $instance = new \Admin\AdminBundle\Admin\SalleAdmin('sonata.admin.salle', 'Admin\\AdminBundle\\Entity\\Salle', 'SonataAdminBundle:CRUD');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('web_master');
        $a->setPassword('webmaster');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin('amro.masters@gmail.com', array());
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Blogger\\BlogBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Admin\\AdminBundle/Resources/views'), 'AdminAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'web_master',
            'mailer_password' => 'webmaster',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'web_master',
            'swiftmailer.mailer.default.transport.smtp.password' => 'webmaster',
            ...
            'swiftmailer.mailer.default.single_address' => 'amro.masters@gmail.com',
            'swiftmailer.mailer.default.delivery_whitelist' => array(

            ),
            'swiftmailer.spool.enabled' => true,
            'swiftmailer.delivery.enabled' => true,
            'swiftmailer.single_address' => 'amro.masters@gmail.com',
